...
import com.hitsuji.camera.R.id;
import com.hitsuji.camera.R.layout;
import com.util.Log;
...
OnSeekBarChangeListener {
	...
	private static final String ROBOBUNNYNS="http://hitsuji.com";
	...
	private void setValuesFromXml(AttributeSet attrs) {
		mMaxValue = attrs.getAttributeIntValue(ROBOBUNNYNS, "max", 100);
		...
		try {
			...
			Log.e(TAG, "Invalid interval value:"+e.getMessage());
		}
	...
	protected View onCreateView(ViewGroup parent){
		...
		{
			Log.e(TAG, "Error creating seek bar preference: " +e.getMessage());
		}
	...
	protected void updateView(View view) {
		...
		try {
			...
			Log.e(TAG, "Error updating seek bar preference:"+e.getMessage());
		}
